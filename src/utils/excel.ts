/*
 * @FilePath: \vue-typescript-admin-template\src\utils\excel.ts
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-18 13:58:31
 * @Reference: 引用方 src\views\excel\export-excel.vue
 * @Descripttion: 说明 框架-侧边栏-Excel-导出Excel-导出脚本excel脚本
 */

import { saveAs } from 'file-saver'
import XLSX, { WorkBook, WorkSheet } from 'xlsx'// excel模块
