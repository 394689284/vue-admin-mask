<!--
 * @FilePath: \vue-typescript-admin-template\src\views\dashboard\admin\components\PanelGroup.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-17 18:48:29
 * @Reference: 引用方 src\views\dashboard\admin\index.vue
 * @Descripttion: 说明 框架-主页-管理员首页-头部面板格子
-->

<template>
  <!-- 间隔40 -->
  <el-row :gutter="40" class="panel-group">
    <!-- xs 768 xm 992  md 1024 lg 1200 xl 1980 -->
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('shoppings')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">售出量</div>
          <count-to
            :start-val="0"
            :end-val="13600"
            :duration="3600"
...
import CountTo from 'vue-count-to' // Vue 数字滚动插件
