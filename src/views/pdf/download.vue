<!--
 * @FilePath: \vue-typescript-admin-template\src\views\pdf\download.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-18 12:11:03
 * @Reference: 引用方 src\views\pdf\index.vue
 * @Descripttion: 说明 PDF案例
-->

<template>
  <!-- 全屏文件加载锁定遮罩 fullscreen -->
  <div
...
import content from './content' // 读取PDF内容
