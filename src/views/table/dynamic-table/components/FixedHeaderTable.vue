<!--
 * @FilePath: \vue-typescript-admin-template\src\views\table\dynamic-table\components\FixedHeaderTable.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-19 11:03:44
 * @Reference: 引用方
 * @Descripttion: 说明 固定表头
-->
<template>
