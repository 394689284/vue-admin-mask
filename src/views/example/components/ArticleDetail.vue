<!--
 * @FilePath: \vue-typescript-admin-template\src\views\example\components\ArticleDetail.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-19 09:12:26
 * @Reference: 引用方 src\views\example\list.vue
 * @Descripttion: 说明 框架-侧边栏-综合案例-文章创建-文章详情
-->
<template>
...
import MaterialInput from '@/components/MaterialInput/index.vue' // 简约输入框
import Sticky from '@/components/Sticky/index.vue' // 粘性吸顶
import Tinymce from '@/components/Tinymce/index.vue' // 富文本组件
import UploadImage from '@/components/UploadImage/index.vue' // 图片上传组件
...
export default class extends Vue {
  ...
  private submitForm() {
    const tem = this.$refs.postForm as Form
    tem.validate((valid) => {
      if (valid) {
        this.loading = true
        this.$notify({
