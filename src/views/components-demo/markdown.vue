<!--
 * @FilePath: \vue-typescript-admin-template\src\views\components-demo\markdown.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-19 10:30:55
 * @Reference: 引用方
 * @Descripttion: 说明Markdown 标记语言
-->
<template>
...
import MarkdownEditor from '@/components/MarkdownEditor/index.vue' // 导入Markdown编辑器
