<!--
 * @FilePath: \vue-typescript-admin-template\src\views\components-demo\sticky.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-18 18:37:04
 * @Reference: 引用方
 * @Descripttion: 说明 吸顶组件
-->
<template>
  <div>
...
import Sticky from '@/components/Sticky/index.vue' // 吸顶组件
