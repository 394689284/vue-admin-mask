<!--
 * @FilePath: \vue-typescript-admin-template\src\views\permission\role.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-19 11:11:54
 * @Reference: 引用方
 * @Descripttion: 说明 角色权限
-->
<template>
...
export default class extends Vue {
  ...
  private handleCreateRole() {
    ...
    if (this.$refs.tree) {
      const tem = this.$refs.tree as Tree
      tem.setCheckedKeys([])
    }
    this.dialogType = 'new'
