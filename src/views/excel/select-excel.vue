<!--
 * @FilePath: \vue-typescript-admin-template\src\views\excel\select-excel.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-18 14:18:59
 * @Reference: 引用方 src\layout\components\Sidebar\SidebarItem.vue
 * @Descripttion: 说明 框架-侧边栏-Excel-导出可选择表
-->
...
export default class extends Vue {
  ...
  private handleDownload() {
    if (this.multipleSelection.length) {
      ...
      const list = this.multipleSelection // 选中的数据
