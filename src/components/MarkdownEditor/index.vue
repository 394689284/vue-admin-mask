<!--
 * @FilePath: \vue-typescript-admin-template\src\components\MarkdownEditor\index.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-19 10:33:35
 * @Reference: 引用方
 * @Descripttion: 说明 Markdown编辑器
-->
<template>
  <div :id="id" />
</template>
...
import Editor, { EditorOptions } from '@toast-ui/editor' // 导入界面语言
import defaultOptions from './default-options' // 到日默认配置
