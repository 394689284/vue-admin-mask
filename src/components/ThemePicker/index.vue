<!--
 * @FilePath: \vue-typescript-admin-template\src\components\ThemePicker\index.vue
 * @Author: maskMan
 * @Date: 2023-04-09 20:16:27
 * @LastEditTime: 2023-04-19 10:16:17
 * @Reference: 引用方 src\layout\components\Settings\index.vue
 * @Descripttion: 说明 主题颜色选择器
-->
    ...
    return new Promise<void>((resolve) => {
      ...
      xhr.onreadystatechange = () => {
        if (xhr.readyState === 4 && xhr.status === 200) {
          ...
          tem[variable] = xhr.responseText.replace(/@font-face{[^}]+}/, '')
          resolve()
        }
      }
      xhr.open('GET', url)
